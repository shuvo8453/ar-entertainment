<?php
/**
 * AR Entertainment - 100% Original Asset Generator & Database Migrator for Blog Batch 5.4.1 (Articles 1–5)
 * 
 * Generates and embeds 5 brand-new, copyright-safe, cinema-grade featured visual assets:
 * 1. mastering-mobile-video-production: Smartphone Filmmaking & Creator Rig Visual
 * 2. phenomenon-of-ott-platforms: Modern Home Theater & OTT Streaming Lifestyle Visual
 * 3. budget-optimisation-in-social-media-video-production: Compact Studio Cinema Camera Setup Visual
 * 4. tv-commercial-production-process: Director's On-Set Field Monitor & Crew Visual
 * 5. how-to-make-a-documentary: Documentary Jib Crane & Location Cinematographer Visual
 * 
 * Features:
...
echo "========================================================\n";
echo "🛡️ AR ENTERTAINMENT - RECREATING 100% ORIGINAL BLOG ASSETS (BATCH 5.4.1: ARTICLES 1–5)\n";
echo "========================================================\n\n";
...
if (!function_exists('create_gradient_blog_hero_avif')) {
    function create_gradient_blog_hero_avif(string $filename_slug, string $category_name, string $title): string
    {
        ...
        imagestring($img, 5, 80, (int)($h / 2 - 10), strtoupper($title), $white);
...
// 5 Blog Articles Configuration for Batch 5.4.1
$blogs_config = [
    [
        ...
        'source_img' => __DIR__ . '/../../images/mastering-mobile-video-production-og.jpg',
        'target_slug' => 'ar-mastering-mobile-video-production'
    ],
    [
        ...
        'source_img' => __DIR__ . '/../../images/phenomenon-of-ott-platforms-og.jpg',
        'target_slug' => 'ar-phenomenon-of-ott-platforms'
    ],
    [
        ...
        'category_name' => 'OVC & DIGITAL ADS',
        'source_img' => __DIR__ . '/../../images/budget-optimisation-in-social-media-video-production-og.jpg',
        'target_slug' => 'ar-budget-optimisation-in-social-media-video-production'
    ],
    [
        'slug' => 'tv-commercial-production-process',
        'title' => 'TV Commercial Production Process in Bangladesh',
        'category_name' => 'TVC & COMMERCIALS',
        'source_img' => __DIR__ . '/../../images/tv-commercial-production-process-og.jpg',
        'target_slug' => 'ar-tv-commercial-production-process'
    ],
    [
        'slug' => 'how-to-make-a-documentary',
        'title' => 'How To Make A Documentary in Bangladesh: The Ultimate Guide',
        'category_name' => 'FILM FIXER & FILMING IN BD',
        'source_img' => __DIR__ . '/../../images/how-to-make-a-documentary-og.jpg',
        'target_slug' => 'ar-how-to-make-a-documentary'
    ]
];
...
echo "========================================================\n";
echo "🏆 BATCH 5.4.1 ORIGINAL ASSETS & DATABASE UPDATE COMPLETED!\n";
