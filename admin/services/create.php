...
/**
 * AR Entertainment - Add New Service Offering
 * 
 * Icon Selector, TinyMCE Editor, Structured FAQ JSON Builder,
 * and SEO Suite with Live Google SERP Preview.
 */

require_once dirname(__DIR__) . '/auth_check.php';

$page_title = 'Add New Service';
$current_page = 'services_create';
...
// Preset Popular Icons for Film/Video Production
$popular_icons = [
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!verify_csrf()) {
        ...
        // Parse FAQs submitted via repeater
        ...
        // Ensure unique slug
        try {
            $check_slug = db()->prepare("SELECT COUNT(*) FROM services WHERE slug = ?");
            ...
            try {
                $sql = "
                    INSERT INTO services (
                        title, slug, icon, short_summary, content,
                        pricing_note, faqs_json, sort_order, status,
                ...
                set_flash('success', "Service '<strong>" . htmlspecialchars($title) . "</strong>' added successfully!");
...
<div class="admin-main">
    ...
    <main class="admin-content">
            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-1 small text-muted">
                        ...
                        <li class="breadcrumb-item active text-white" aria-current="page">New Service</li>
                    </ol>
                </nav>
                <h3 class="fw-bold mb-0 text-white">Add New Service Offering</h3>
            </div>
            <div>
        ...
        <form method="POST" action="<?= site_url('admin/services/create') ?>" id="serviceForm">
            <?= csrf_field() ?>
                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="card-ar mb-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" id="serviceTitle" class="form-control form-control-lg bg-dark border-secondary text-white" placeholder="e.g. TV Commercial Production in Bangladesh" value="<?= htmlspecialchars($title) ?>" required autofocus>
                        </div>
                    ...
                    <div class="card-ar mb-4">
                        ...
                        <textarea name="short_summary" id="shortSummary" rows="3" class="form-control bg-dark border-secondary text-white" placeholder="A concise 2-sentence description of this service to appear on service cards and grids..."><?= htmlspecialchars($short_summary) ?></textarea>
                    </div>
                    ...
                    <div class="card-ar mb-4">
                        ...
                        <div id="faqContainer">
                            <!-- Dynamic FAQ Items Rendered Here -->
                        </div>

                        <div id="emptyFaqNotice" class="text-center py-4 text-muted">
                ...
                <div class="col-12 col-lg-4">
                    ...
                    <div class="card-ar mb-4">
                        <h6 class="fw-bold text-white border-bottom pb-2 mb-3" style="border-color: var(--ar-border-color) !important;">
                            <i class="fa-solid fa-paper-plane text-danger me-2"></i> Service Status
                        </h6>
                        ...
                        <div class="d-grid gap-2 pt-2 border-top" style="border-color: var(--ar-border-color) !important;">
                            <button type="submit" class="btn btn-ar-primary btn-lg">
                                <i class="fa-solid fa-floppy-disk me-1"></i> Save &amp; Publish Service
                            </button>
                            <a href="<?= site_url('admin/services') ?>" class="btn btn-ar-secondary">
                                Cancel
                            </a>
    ...
    <script>
        ...
        function createFaqItem(question = '', answer = '') {
            const index = faqContainer.children.length + 1;
