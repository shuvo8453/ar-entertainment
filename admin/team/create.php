...
/**
 * AR Entertainment - Add Team Member
 * 
 * Form to register leadership, film directors, producers, cinematography, 
 * post-production specialists, and crew members.
 */
...
if (($_SERVER['REQUEST_METHOD'] ?? '') === 'POST') {
    if (!verify_csrf()) {
        ...
        // Ensure unique slug
        try {
            $check_slug = db()->prepare("SELECT COUNT(*) FROM team_members WHERE slug = ?");
            ...
            try {
                ...
                $sql = "
                    INSERT INTO team_members (
                        name, slug, role_title, bio, photo,
                        email, phone, social_links_json,
                ...
                set_flash('success', "Team member '<strong>" . htmlspecialchars($name) . "</strong>' added successfully!");
                redirect('admin/team');
            } catch (PDOException $e) {
                $errors[] = 'Failed to save team member: ' . $e->getMessage();
            }
        }
    }
}
    ...
    <main class="admin-content">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
            <div>
                ...
                <h3 class="fw-bold mb-0 text-white">Add Team Member Profile</h3>
            </div>
            <div>
        ...
        <form method="POST" action="<?= site_url('admin/team/create') ?>" enctype="multipart/form-data" id="teamForm">
            <?= csrf_field() ?>
                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="card-ar mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" id="memberName" class="form-control form-control-lg bg-dark border-secondary text-white" placeholder="e.g. Azizul Hoque Shiplu" value="<?= htmlspecialchars($name) ?>" required autofocus>
                        </div>
                    ...
                    <div class="card-ar mb-4">
                        ...
                        <div class="text-center mb-3">
                            <div id="imagePreviewContainer" class="d-flex align-items-center justify-content-center mx-auto rounded-3 border border-secondary bg-dark overflow-hidden mb-3" style="width: 180px; height: 180px; position: relative;">
                                <img id="previewImg" src="<?= asset_url('images/placeholder.webp') ?>" alt="Preview" class="w-100 h-100 object-fit-cover d-none">
                    ...
                    <div class="card-ar mb-4">
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary py-2 fw-bold">
                                <i class="fa-solid fa-check-circle me-2"></i> Save Team Member
                            </button>
                            <a href="<?= site_url('admin/team') ?>" class="btn btn-outline-secondary py-2">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Auto-generate slug from name unless unlocked
    if (memberNameInput && memberSlugInput) {
