                ...
                <div class="col-12 col-lg-4">
                    ...
                    <div class="card-ar mb-4">
                        ...
                        <div>
                            ...
                            <input type="file" name="logo" id="logoFile" class="form-control bg-dark border-secondary text-white" accept=".png,.webp,.avif,.jpg,.jpeg,.jfif,.svg">
                            <div class="form-text text-muted small">
                                Leave blank to keep existing logo. Allowed: PNG, WebP, JPG, JPEG, JFIF, AVIF, SVG (Max 5MB).
                            </div>
                        </div>
                    </div>
